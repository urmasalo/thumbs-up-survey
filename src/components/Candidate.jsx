...
const Candidate = ({ image, name, description, last_update, categories }) => {
  ...
  const unpopularity = popularity > 0 ? 100 - popularity : 0;
  ...
  return (
    <div className="candidates__card">
      ...
      <h3 className="candidates__card__description">{description}</h3>
      ...
      <div className="candidates__graphic-report">
        ...
        {/* stats bar */}
        <div className="candidates__graphic-report__values">
          <div className="">
